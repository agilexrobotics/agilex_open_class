...
def generate_launch_description():
    ...
    # map_yaml_path = LaunchConfiguration('map',default=os.path.join(limo_bringup_dir,'maps','map04.yaml'))
    nav2_param_path = LaunchConfiguration('params_file',default=os.path.join(limo_bringup_dir,'param','nav2_explore.yaml'))
