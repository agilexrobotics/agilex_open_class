...
int main(int argc, char** argv)
{
  ...
  if (plan_solution1)
  {
    ...
    visual_tools.publishAxisLabeled(robot_start_state->getGlobalLinkTransform("link6"), "start_pose");
  ...
  // for panda robot we have one named robot state for "arm" planning group called "ready"
  // see `arm.xacro
  // <https://github.com/ros-planning/moveit_resources/blob/ros2/panda_moveit_config/config/arm.xacro#L13>`_
